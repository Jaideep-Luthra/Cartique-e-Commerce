          ...
          >
            <div className="row g-4">
              <div className="col-lg-3">
                <a href="#">
                  <h1 className="text-primary mb-0">Cartique</h1>
          ...
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <p className="mb-4">
                  Premium quality, unbeatable freshness, fast delivery — we make healthy eating easy and enjoyable every day.
                </p>
                <a
                  href=""
